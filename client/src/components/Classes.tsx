export enum ButtonCLasses {
    ARROW = "rounded-lg h-10 w-10 flex items-center justify-center hover:bg-stone-700 hover:bg-opacity-25",
...
export enum NavClasses {
    PARENT = "w-60 h-screen bg-gradient-to-br from-stone-200 to-stone-100 flex flex-cols justify-center items-center p-8",
    ...
    MENU = "absolute top-0 left-0 p-8 cursor-pointer hover:scale-90",
}